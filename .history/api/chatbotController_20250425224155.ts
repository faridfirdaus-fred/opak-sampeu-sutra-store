...
const openai = new OpenAIApi(
  new Configuration({
    apiKey: process.env.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, // Pastikan API key disimpan di .env
  })
);
