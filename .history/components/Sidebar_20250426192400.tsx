...
import { IconBox, IconCategory, IconMagnet, IconDashboard } from "@tabler/icons-react";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
    ...
    <Sidebar collapsible="offcanvas" className="border-r shadow-sm" {...props}>
      ...
      <SidebarFooter className="border-t p-4">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-xs text-center text-muted-foreground">© 2025 Opak Sampeusutra</p>
        </div>
      </SidebarFooter>
    </Sidebar>
  );
