...
import { FaRobot, FaPaperPlane, FaTimes, FaShoppingCart, FaTruck, FaBoxOpen, FaClipboardList } from "react-icons/fa";
...
export default function Chatbot() {
  ...
  const handleSendMessage = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      setMessages((prev) => [...prev, { type: "bot", content: "Maaf, ada masalah dengan sistem. Silakan coba lagi nanti." }]);
    }
  };
  ...
  return (
    <>
      ...
      >
        <button
          className="w-16 h-16 rounded-full bg-[#FF7722] text-white flex items-center justify-center shadow-lg hover:bg-[#FF6600] transition-colors"
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-xs flex items-center">
                ...
                Online <span className="ml-1 opacity-75">Respon rata-rata: 30 detik</span>
              </div>
            </div>
          </div>
          <button 
