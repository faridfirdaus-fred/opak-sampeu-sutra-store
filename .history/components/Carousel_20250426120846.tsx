...
export default function HomeCarousel() {
  ...
  return (
    <div className="relative items-center mx-auto w-full h-full px-4 md:px-20 py-16">
      <Carousel className="w-full relative">
        <CarouselContent className="w-full">
          {slides.map((url, index) => (
            ...
            >
              <div className="w-full  h-[400px] justify-content-center md:h-[500px] rounded-xl overflow-hidden shadow-lg flex items-center justify-center bg-white">
                <img
                  src={url}
                  alt={`Slide ${index + 1}`}
                  className="w-full h-full object-contain mx-aut"
                />
              </div>
            </CarouselItem>
          ))}
