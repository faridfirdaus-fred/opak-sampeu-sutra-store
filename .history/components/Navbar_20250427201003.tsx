        ...
        <div className="relative">
          {session ? (
              ...
              {showLogoutCard && (
                <Card className="absolute right-0 mt-2 w-48">
                  <CardContent>
                    ...
                    <button
                      onClick={() => signOut()}
                      className="mt-2 w-full px-4 py-2 text-sm font-medium text-white bg-primary rounded hover:bg-primary-foreground"
                    >
                      Logout
                    </button>
                  </CardContent>
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-white bg-primer hover:bg-darken-primer rounded-2xl"
            >
              Login
            </button>
          )}
