...
export default function ProductForm({
 ...
 const onDrop = async (acceptedFiles: File[]) => {
   ...
   try {
     ...
     formData.append("upload_preset", "product"); // This is the upload preset name

     // Add these lines to provide additional parameters
     formData.append("api_key", "295988297124227");
     formData.append(
       "timestamp",
     ...
     const response = await axios.post(
       `https://api.cloudinary.com/v1_1/dsc57r0af/image/upload`,
       formData
     );
