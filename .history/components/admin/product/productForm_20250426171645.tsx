...
export default function ProductForm({
  ...
  const {
    ...
    defaultValues: {
      ...
      price: 0,
      stock: 0,
      category: undefined as "OPAK" | "BASTIK" | "KACANG" | undefined,
      container: undefined as "TOPLES" | "BOX" | undefined,
      imageUrl: "",
    },
  });
    ...
    if (isOpen) {
      if (product) {
        reset({
          ...
          category: (product.category as "OPAK" | "BASTIK" | "KACANG") || undefined,
          container: (product.container as "TOPLES" | "BOX") || undefined,
  ...
  const onSubmit = (formData: {
    ...
    price: number;
    stock: number;
    category: "OPAK" | "BASTIK" | "KACANG" | undefined;
    container: "TOPLES" | "BOX" | undefined;
    imageUrl: string;
  }) => {
    onSave(formData);
  };
