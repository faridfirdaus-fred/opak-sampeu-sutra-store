    ...
    >
            ...
            {banners.map((banner) => (
              ...
              >
                <TableCell className="py-4 text-center">
                  <div className="w-32 h-20 relative rounded-lg overflow-hidden bg-slate-100 border border-slate-200 shadow-sm mx-auto">
                    {banner.imageUrl ? (
                      <img
                        src={banner.imageUrl}
                        alt={banner.title}
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-white border-t mt-px">
        <div className="text-sm text-slate-500">
          ...
          of <span className="font-medium text-slate-700">{totalBanners}</span>{" "}
          banners
        </div>
