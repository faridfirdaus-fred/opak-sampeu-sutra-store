...
export default function Chatbot() {
  ...
  return (
    <>
      ...
      >
        <button className="w-16 h-16 rounded-full tw:bg-primary text-white flex items-center justify-center shadow-lg tw:hover:bg-darken-primary transition-colors">
